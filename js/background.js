      ...
      : (function (e, t) {
          return (
            ...
            Object.keys(e.popup_settings).length !==
              Object.keys(n.popup_settings).length
          );
        })(o, r) &&
        (Object.keys(n).forEach((e) => {
          Object.prototype.hasOwnProperty.call(o, e)
            ...
            : "hide_transcript" === e &&
              Object.prototype.hasOwnProperty.call(o, "hide_sidebar")
            ? (n[e] = o.hide_sidebar)
            : "yt_on" === e &&
              Object.prototype.hasOwnProperty.call(o, "yt_off") &&
              (n[e] = !o.yt_off);
        }),
        e.clear(() => {
    ...
    r.storage.onChanged.addListener((e) => {
      for (let t = 0; t < d.length; t += 1)
        if (Object.prototype.hasOwnProperty.call(e, d[t])) {
          "yt_off" === d[t] && i(e.yt_off.newValue), h();
          break;
        }
    }),
    r.webRequest.onBeforeRequest.addListener(
      ({ url: e, tabId: t }) => {
        c.yt_off ||
          (((c.hide_trending &&
            /^https:\/\/.*\.youtube\.com\/feed\/(trending|explore)/.test(e)) ||
            (c.hide_subs && -1 !== e.indexOf("subscriptions"))) &&
            p("https://www.youtube.com", t),
          c.hide_redirect_home &&
            c.hide_feed &&
            !c.hide_subs &&
            /^https:\/\/.*\.youtube\.com\/(?:\?.*)?$/.test(e) &&
            p("https://www.youtube.com/feed/subscriptions", t));
      },
      {
        urls: [
          "https://*.youtube.com/",
