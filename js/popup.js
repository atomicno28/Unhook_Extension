(() => {
  ...
  (() => {
    ...
    function c(e) {
      ...
      if (n.checked) return;
      let o = !1;
      for (let e = 1; !o && e < t.length; e += 1)
        (t[e].checked || t[e].indeterminate) && (o = !0);
      o && (n.indeterminate = !0);
    }
    function d(e, t) {
      ...
      Object.keys(e).forEach((t) => {
        if ("boolean" == typeof e[t]) {
          ...
          Object.keys(e[t]).forEach((n) => {
            ...
            if (
              (o && (o.checked = e[t][n]), "dark_mode" === n || "yt_on" === n)
            )
              s.setAttribute(n, e[t][n]);
            else {
              const o = document
                .getElementById(n)
    ...
    function i(e, t, n) {
      ...
      (s[t] = n), o({ popup_settings: s });
    }
    function r() {
      const e = this.checked,
        t = this.id;
      if ((n(i, ["popup_settings"], [t, e]), "dark_mode" === t))
        s.setAttribute(t, e);
      else {
        const t =
          this.parentNode.parentNode.parentNode.getElementsByTagName("ul")[0];
    ...
    function m(e, t) {
      ...
      !1 === t
        ? ((o.indeterminate = !1), (o.checked = !1), c(n))
        : (o.indeterminate = !0);
    ...
    function h(e) {
      ...
      Object.keys(e).forEach((n) => {
        ...
        Object.prototype.hasOwnProperty.call(t, "hide_feed")
          ? d(t.hide_feed, e.hide_subs)
          : Object.prototype.hasOwnProperty.call(t, "hide_subs") &&
            d(e.hide_feed, t.hide_subs),
        o(t);
    }
    function u() {
      const e = this.checked,
    ...
    function f(e) {
      s.setAttribute("yt_on", e), o({ yt_on: e });
    }
